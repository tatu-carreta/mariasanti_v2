...
@section('contenido')
    ...
    <section class="container" id="ng-app" ng-app="app">
        ...
        {{ Form::open(array('url' => $prefijo.'admin/muestra/editar', 'files' => true, 'role' => 'form')) }}
            ...
            <div class="form-group marginBottom2">
                <input class="form-control" type="text" name="titulo" placeholder="Título de la muestra" required="true" value="{{ $item->lang()->titulo }}" maxlength="50">
            </div>
